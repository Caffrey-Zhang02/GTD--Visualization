...
yzh_svg.append("g")
    ...
    .on("mouseout", function() { d3.select(this).attr("fill", "rgba(65, 67, 69, 0.62)"); });
...
/// add legend
yzh_svg.append("text").attr("x", 30).attr("y", 300).text("谁是最容易遭到恐怖袭击的目标？：").style("font-size", "24px").attr("alignment-baseline","middle").style("fill", "#000000")
...
yzh_svg.append("text").attr("x", 71).attr("y", 490).text("平民").style("font-size", "20px").attr("alignment-baseline","middle").style("fill", "#000000")
...
yzh_svg.append("text").attr("x", 200).attr("y", 490).text("士兵").style("font-size", "20px").attr("alignment-baseline","middle").style("fill", "#000000")
...
yzh_svg.append("text").attr("x", 290).attr("y", 490).text("交通工具").style("font-size", "20px").attr("alignment-baseline","middle").style("fill", "#000000")
...
yzh_svg.append("text").attr("x", 404).attr("y", 490).text("检查点").style("font-size", "20px").attr("alignment-baseline","middle").style("fill", "#000000")
...
yzh_svg.append("text").attr("x", 495).attr("y", 490).text("交通管理者").style("font-size", "20px").attr("alignment-baseline","middle").style("fill", "#000000")



yzh_svg.append("text").attr("x", 770).attr("y", 30).text("事件数量").style("font-size", "20px").attr("alignment-baseline","middle").style("fill", "#FFFFFF")
yzh_svg.append("text").attr("x", 770).attr("y", 170).text("伤亡人数").style("font-size", "20px").attr("alignment-baseline","middle").style("fill", "#FFFFFF")
